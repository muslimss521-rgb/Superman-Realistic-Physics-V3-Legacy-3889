...
void TriggerHeatVisionJulioNIB()
{
    ...
    nativePush(2);
    nativeCall();
    camRotX = *(float*)nativeCall();
    camRotY = *(float*)nativeCall();
    camRotZ = *(float*)nativeCall();

    nativeInit(0xFAAA931A783AEC66);
    nativeCall();
    camCoordX = *(float*)nativeCall();
    camCoordY = *(float*)nativeCall();
    camCoordZ = *(float*)nativeCall();
...
void UpdateSupermanPhysics()
{
    ...
    nativeInit(0x32A66C31C68491A1); nativePush(0); nativePush(32); 
    float wInput = *(float*)nativeCall();
    
    nativeInit(0x32A66C31C68491A1); nativePush(0); nativePush(33); 
    float sInput = *(float*)nativeCall();
    
    nativeInit(0x32A66C31C68491A1); nativePush(0); nativePush(34); 
    float aInput = *(float*)nativeCall();
    
    nativeInit(0x32A66C31C68491A1); nativePush(0); nativePush(35); 
    float dInput = *(float*)nativeCall();
    ...
    float currentFrameTime = *(float*)nativeCall();
    g_currentSpeed += acceleration * currentFrameTime;
    ...
    if (g_currentSpeed >= SOUND_SPEED && isBoosting)
    {
        ...
        float coordsX = *(float*)nativeCall();
        float coordsY = *(float*)nativeCall();
        float coordsZ = *(float*)nativeCall();
    ...
    nativeInit(0x3C5C3E2C22D3E3E2); nativePush(playerPed); nativePush(true); nativeCall();
    float pCoordsX = *(float*)nativeCall();
    float pCoordsY = *(float*)nativeCall();
    float pCoordsZ = *(float*)nativeCall();
    
    nativeInit(0x3201E3E66F1CEDE2);
    nativePush(1); nativePush(pCoordsX); nativePush(pCoordsY); nativePush(pCoordsZ - 1.0f);
