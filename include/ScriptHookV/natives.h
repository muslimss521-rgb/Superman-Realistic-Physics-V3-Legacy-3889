...
void UpdateSupermanPhysics()
{
    ...
    // Смена режима полета через CONTROLS
    ...
    // Время кадра берется из GAMEPLAY в старых SDK
    ...
    // Взрыв скорректирован строго под 7 аргументов вашей строки 4201 в natives.h
